...
const Cart = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Your Shopping Cart | ECCOH Webshop</title>
        <meta
          name="description"
          content="Review the items in your cart at ECCOH Webshop. Ready to checkout? Proceed to finalize your order."
        />
        <meta
          name="keywords"
          content="ECCOH, shopping cart, checkout, ecommerce, webshop"
        />
        <meta
          property="og:title"
          content="Your Shopping Cart | ECCOH Webshop"
        />
        <meta
          property="og:description"
          content="Check the items in your cart and proceed to checkout at ECCOH Webshop."
        />
      </Helmet>
